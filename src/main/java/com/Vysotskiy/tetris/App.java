    ...
    public void start(Stage primaryStage) {
        ...
        game.getView().canvas.setOnKeyPressed(e -> {
            ...
            if (key.equals(KeyCode.UP))
                game.getController().changeAction(game.getModel().getThisFigure(), game.getModel().getField());
            if (key.equals(KeyCode.DOWN))
                game.getController().dropAction(game.getModel().getThisFigure(), game.getModel().getField());
            if (key.equals(KeyCode.LEFT))
                game.getController().leftAction(game.getModel().getThisFigure(), game.getModel().getField());
            if (key.equals(KeyCode.RIGHT))
                game.getController().rightAction(game.getModel().getThisFigure(), game.getModel().getField());
